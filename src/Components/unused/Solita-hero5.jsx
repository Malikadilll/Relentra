  ...
  useEffect(() => {
    ...
    class Particle {
      constructor() {
        ...
        this.randomYOffset = (Math.random() - 0.5) * 100;
      ...
      draw() {
        // --- CHANGED: Opacity increased to 0.3 (30%) ---
      ...
      update() {
        ...
        let targetY = (window.innerHeight / 2) + wave1 + wave2 + this.randomYOffset;
    ...
    const initParticles = () => {
      particlesArray = [];
      for (let i = 0; i < 600; i++) particlesArray.push(new Particle());
    };
